...
export type ObservableRequest = { id: RequestId, next: unknown }
...
export type SubscribeResponse = { id: RequestId, observable: string, subscribe: true }
...
export type RequestMapper = {
  ...
  __observable: [Observable<unknown>, { __observable: string }, Observable<unknown>]
}
